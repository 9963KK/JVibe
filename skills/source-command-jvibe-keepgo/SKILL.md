---
name: "source-command-jvibe-keepgo"
description: "自动继续推进项目任务，基于当前文档进度"
---

# source-command-jvibe-keepgo

Use this skill when the user asks to run the migrated source command `JVibe:keepgo`.
...
- **异常处理一致**：遵循 `.Codex/error-handling.md`
...
- 禁止修改 `.Codex/` 目录及其内容（以及 `.opencode/`，如存在）
