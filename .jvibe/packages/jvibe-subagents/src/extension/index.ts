 ...
 *
 * Config file: ~/.jvibe/agent/extensions/subagent/config.json
 ...
 * If parent session is ~/.jvibe/agent/sessions/abc123.jsonl,
 * returns ~/.jvibe/agent/sessions/abc123/ as the base.
...
function loadConfig(): ExtensionConfig {
	const configPath = path.join(os.homedir(), ".jvibe", "agent", "extensions", "subagent", "config.json");
	try {
