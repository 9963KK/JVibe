...
export function formatAsyncStartedMessage(headline: string): string {
	return [
		...
		"If you have independent work, continue that work. If you have nothing else to do until the async result arrives, end your turn now; JVibe will deliver the completion when the run finishes.",
